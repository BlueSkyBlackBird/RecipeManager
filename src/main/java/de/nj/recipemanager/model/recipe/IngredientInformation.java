...
public class IngredientInformation
{
    ...
    public IngredientInformation copy()
    {
        IngredientInformation copy = new IngredientInformation();
        copy.amount = this.amount;
        copy.ingredientName = this.ingredientName;
        copy.unitOfQuantity = this.unitOfQuantity;
        return copy;
    }
